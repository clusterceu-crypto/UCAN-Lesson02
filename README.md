# UCAN Lesson 02 — Gold Release v2.6
...
Актуальні документи розміщені в каталозі `docs/`. Опис навігаційних змін міститься у `docs/RELEASE_NOTES_v2.6.md`. Контрольні суми всіх файлів пакета містяться у `docs/PACKAGE_MANIFEST_v2.6.sha256`.
